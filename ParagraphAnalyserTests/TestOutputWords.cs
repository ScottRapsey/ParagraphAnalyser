...
namespace ParagraphAnalyserTests
{
    ...
    public class TestOutputWords
    {
        ...
        {
            var groupedWords = ParagraphAnalyser.ParagraphAnalyser.GetWordsGroupedBySeperators("A");
        ...
        public void TestFromSpecIncludeOther()
        {
            ...
            var groupedWords = ParagraphAnalyser.ParagraphAnalyser.GetWordsGroupedBySeperators(text);
